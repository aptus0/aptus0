...
## 🧩 Kısa CV Summary
21 yaşında, aktif olarak yazılım geliştiren bir geliştiriciyim; web ve mobil ürün geliştirmeyi, backend/API tasarımını ve güvenlik odaklı yaklaşımları aynı çatı altında ele alırım.

Şu anda **Salesforce Developer** olarak Apex ve Java tabanlı geliştirmeler yapıyor, kurumsal CRM çözümlerinde cloud tabanlı mimarilerle ölçeklenebilir entegrasyonlar üretiyorum.

Modern toolchain (Git/GitHub, VS Code) ile hızlı teslim, sürdürülebilir kod ve net dokümantasyon odağında; startup ve kurumsal ekiplerle üretime hazır işler çıkarmayı hedeflerim.

---

## 👤 Hakkımda
Ben **Samet Er**. 2019–2023 döneminde mezuniyet sürecimi tamamladıktan sonra yazılım geliştirmeyi profesyonel olarak sürdürdüm; Anadolu Üniversitesi Bilgisayar Programcılığı (Açıköğretim) programında eğitimime devam ediyorum.

Ürün geliştirirken önceliğim; anlaşılır domain modeli, güvenli veri akışı ve bakımı kolay bir mimaridir. Web application geliştirmede modern front-end pratikleriyle (component-driven UI, tip güvenliği, build pipeline) ilerlerken; backend/API tarafında sürdürülebilir sözleşmeler, versiyonlama, doğrulama ve performans optimizasyonlarıyla üretime hazır çözümler geliştiririm.

Güvenlik odağım pratik ve ölçülebilirdir: pentesting ve web security alanındaki yaklaşımım sadece “bulgu” üretmek değil; riskleri azaltan, izlenebilir ve doğru yapılandırılmış sistemler kurmaktır. Cloud & DevOps tarafında ise dağıtım, loglama ve operasyonel görünürlük gibi başlıklarda sürdürülebilir süreçler tasarlamayı önemserim.

Güncel rolümde Salesforce Platform üzerinde Apex ile geliştirme yapıyor; kurumsal CRM çözümlerinde Apex/Java perspektifiyle entegrasyonlar ve cloud tabanlı mimariler geliştiriyorum. Bu sayede hem ürün hızını hem de kurumsal standartları aynı anda karşılayan bir teslim kalitesi hedefliyorum.

---

## 🛠️ Teknik Yetkinlikler (Tablo)
...
| Araçlar & Platformlar | <img alt="VSCode" src="https://img.shields.io/badge/VS%20Code-007ACC?logo=visualstudiocode&logoColor=white" /> <img alt="Git" src="https://img.shields.io/badge/Git-F05032?logo=git&logoColor=white" /> <img alt="GitHub" src="https://img.shields.io/badge/GitHub-181717?logo=github&logoColor=white" /> <img alt="Salesforce" src="https://img.shields.io/badge/Salesforce-Apex-00A1E0?logo=salesforce&logoColor=white" /> |
